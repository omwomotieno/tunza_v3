...
Antenatal care reminder system
...
.. code-block:: bash
    ...
    cd tunza_v2
    celery -A tunza_v2.taskapp worker -l info
...
To run the tests, enter the tunza_v2/tests directory and run the following commands::
